        ...
        <div className='absolute mt-5 bg-primary px-4 py-4 rounded-window'
            ...
            <div className='bg-secondary px-4 pb-32 pt-10 bottom-rounded-window'>
                ...
                <div className='mt-2 text-text text-center'>
                    ...
                    <input id='internet' className='ml-4 cursor-pointer mr-1' type='checkbox' name='choice' value='internet'
                           onClick={() => console.log()}/>
                    <label className='cursor-pointer uppercase' htmlFor='internet'>Internet</label>

                    <input id='cinema' className='ml-4 cursor-pointer mr-1' type='checkbox' name='choice' value='cinema'
                           onClick={() => console.log()}/>
